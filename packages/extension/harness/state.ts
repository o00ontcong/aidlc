...
export const STATE: WorkspaceState = {
  ...
  foundation: {
    status: 'ready',
    revision: 3,
    contentHash: '0ddcc0ffee0ddcc0ffee0ddcc0ffee0ddcc0ffee0ddcc0ffee0ddcc0ffee0ddc',
    sourceCommit: '2a0f6beeb8b8a07cd799cc10e9950a1071f4c171',
    publishedAt: '2026-08-16T03:00:00Z',
  },
  shapes: [
    {
      id: 'SHAPE-004',
      title: 'Make failed sign-in easier to recover from',
      status: 'exploring',
      revision: 2,
      problem: 'People who use an unknown email reach a dead end and do not know what to do next.',
      desiredOutcome: 'A person can understand why sign-in failed and choose a safe next step without contacting support unnecessarily.',
      appetite: 'One focused delivery cycle',
      constraints: ['Keep the existing password and passkey happy paths unchanged.'],
      options: [
        {
          id: 'guided-recovery',
          title: 'Guided recovery sheet',
          summary: 'Explain the problem and show only the recovery actions that apply.',
          tradeoffs: ['Adds a small amount of conditional UI copy.'],
        },
      ],
      selectedApproach: 'Show a guided recovery sheet with contextual actions.',
      rationale: 'It removes the dead end without changing authentication or creating a new account flow.',
      risks: ['Support contact data may not be available for every organization.'],
      noGos: ['Do not add self-service sign-up.', 'Do not change CoreAuth.'],
      acceptanceCriteria: [
        'An unknown email shows a clear explanation and a Try another email action.',
        'The existing password and passkey paths behave exactly as before.',
      ],
      architectureImpact: 'Presentation-only change in the sign-in recovery surface.',
      openQuestions: ['Should Contact admin appear only when the organization provides support details?'],
      foundationRevision: 3,
      foundationHash: '0ddcc0ffee0ddcc0ffee0ddcc0ffee0ddcc0ffee0ddcc0ffee0ddcc0ffee0ddc',
      readinessBlockers: ['Resolve or explicitly remove all open questions.'],
