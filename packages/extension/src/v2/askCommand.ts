...
const QUICK_ANSWERS: QuickAnswer[] = [
  {
    ...
    answer: [
      ...
      '3. Use **Start new delivery**; AIDLC opens visible Claude master command `/aidlc-autonomous-delivery <delivery-id>` for one independent feature epic: context → contract → implementation/tests → PR → aggregate review.',
