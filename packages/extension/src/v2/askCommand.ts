...
const QUICK_ANSWERS: QuickAnswer[] = [
  {
    ...
    answer: [
      ...
      '3. Use **Start new delivery**; AIDLC opens visible Claude master command `/aidlc-autonomous-delivery <delivery-id>` for one independent feature epic: context → contract → implementation/tests → PR → project sync. It auto-approves validated phase gates.',
      ...
      '5. It pauses only for an unresolved product/architecture/ship-policy question (or a real external blocker), not for normal human approval gates.',
      '',
