...
2. Tôi muốn đổi cách sắp xếp / lọc một danh sách — sửa ở đâu, ai bị ảnh hưởng?
...
2. Tài liệu kiến trúc sẵn có — **trích dẫn và trỏ tới, đừng viết lại từ đầu**
3. Thân hàm của type sở hữu state (store / service / view-model) — nơi mọi mutation đi qua
...
- Không viết code, không sửa source
